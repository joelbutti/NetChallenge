...
namespace NetChallenge.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240205183125_valueObjectsEntities")]
    partial class valueObjectsEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetChallenge.Domain.Entities.Booking", b =>
                {
                    b.HasOne("NetChallenge.Domain.Entities.Office", null)
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("NetChallenge.Domain.Entities.Location", b =>
                {
                    ...
                    b.OwnsOne("NetChallenge.Domain.ValueObjects.Neighborhood", "Neighborhood", b1 =>
                        {
                            b1.Property<Guid>("LocationId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NetChallenge.Domain.Entities.Office", b =>
                {
                    b.HasOne("NetChallenge.Domain.Entities.Location", null)
                        .WithMany("Offices")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
